        ...
        <section className="projects">
            ...
            <article className="projects__grid">
                ...
                <ProjectCard
                    ...
                    cardParagraph={"A fully responsive travel-guide landing page following Figma designs, using HTML5, CSS Grid and Flexbox methods"}
                ...
                <ProjectCard
                    ...
                    cardParagraph={"A series of small Javascript exercises displaying a range of functions, widgets, and designs"}
                ...
                <ProjectCard
                    ...
                    cardParagraph={"A basic page focusing on optimizing learning techniques, made with image/video embedding, and CSS animations"}
