    ...
    <AboutSection>
      ...
      <AboutExterior>
        ...
        <AboutInfo>
          ...
          <AboutMe>
            <AboutParagraph>
              I'm a traveler and freelance web developer with a passion for injecting life into
              everything I create. I design and build websites that are elegant in their simplicity,
              and try to combine the architectural with the aesthetic. I aim to create works of art
            ...
            <AboutIcons>
              <IconLink href='https://github.com/cjmaret' target='_blank' rel='noreferrer'>
              ...
              <IconLink href='https://dribbble.com/cjmaret' target='_blank' rel='noreferrer'>
